...
//  Sala_WordGuess
//
//  Created by Sravya Geethika Sala on 3/5/25.
//
...
class ViewController: UIViewController {
    ...
    var words = [
            (word: "Sala", hint: "Sravya Geethika", image: UIImage(named: "nwmsu")),
            (word: "Swift", hint: "Programming language", image: UIImage(named: "swift")),
            (word: "Dog", hint: "Animal", image: UIImage(named: "dog")),
            (word: "Macbook", hint: "Apple Device", image: UIImage(named: "laptop")),
            (word: "Tree", hint: "Grows in nature", image: UIImage(named: "tree"))
    ];
    ...
    @IBAction func guessLetterFieldChanged(_ sender: UITextField) {
        let textEntered = sender.text?.trimmingCharacters(in: .whitespacesAndNewlines) ?? ""
                guessLetter.isEnabled = !textEntered.isEmpty // Enable Guess button if valid character is entered
    }
